...
указал smtp.mail.ru, а порт smtp.mail.ru - 25 или 2525 */
            ...
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new NetworkCredential(MailFrom, StringCipher.Decrypt(Password, "SomeVeryLongAndSecurePassphrase"));
...
указал smtp.mail.ru, а порт smtp.mail.ru - 25 или 2525 */
                ...
                Attachment attachment;
                attachment = new Attachment(Singelton.EmailSetting.PathAttachmentFile);
                mail.Attachments.Add(attachment);
                SmtpServer.Port = 587;
                SmtpServer.Credentials = new NetworkCredential(Singelton.EmailSetting.MailFrom,
