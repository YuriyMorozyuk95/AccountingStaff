...
namespace Rfid.Helpers
{
    public class UserTableItem
    {
        ...
        {
            var res = new List<UserTableItem>();

            foreach (var obj in dg.ItemsSource)
            {
                var item = new UserTableItem();
    ...
    public class TimeTableItem
    {
        ...
        {
            var res = new List<TimeTableItem>();
    ...
    { 
        ...
        {
            var res = new List<DepartmentTableItem>();

            foreach (var obj in dg.ItemsSource)
            {
                var item = new DepartmentTableItem();
                var type = obj.GetType();
